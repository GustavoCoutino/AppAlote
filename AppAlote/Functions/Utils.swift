...
func addToScene(_ scene: SCNScene, _ path: UIBezierPath, _ depth: CGFloat, _ name: String, _ position: SCNVector3, _ color: UIColor){
    ...
    pathMaterial.diffuse.contents = color
    pathShape.materials = [pathMaterial]
    let pathNode = SCNNode(geometry: pathShape)
...
func setupFloor0(_ scene: SCNScene, _ width: Double, _ height: Double){
    ...
    path.addCurve(to: CGPoint(x: 0.58241 * width, y: 0.94896 * height), controlPoint1: CGPoint(x: 0.5638 * width, y: 0.94173 * height), controlPoint2: CGPoint(x: 0.57519 * width, y: 0.94757 * height))
    path.addLine(to: CGPoint(x: 0.74682 * width, y: 0.94896 * height))
    path.addCurve(to: CGPoint(x: 0.76504 * width, y: 0.94146 * height), controlPoint1: CGPoint(x: 0.75257 * width, y: 0.94777 * height), controlPoint2: CGPoint(x: 0.76182 * width, y: 0.94484 * height))
    path.addCurve(to: CGPoint(x: 0.7725 * width, y: 0.9335 * height), controlPoint1: CGPoint(x: 0.76712 * width, y: 0.9396 * height), controlPoint2: CGPoint(x: 0.77085 * width, y: 0.93561 * height))
    ...
    path.addCurve(to: CGPoint(x: 0.98833 * width, y: 0.65314 * height), controlPoint1: CGPoint(x: 0.98595 * width, y: 0.66919 * height), controlPoint2: CGPoint(x: 0.98903 * width, y: 0.65891 * height))
    path.addLine(to: CGPoint(x: 0.96182 * width, y: 0.48075 * height))
    path.addCurve(to: CGPoint(x: 0.94512 * width, y: 0.46509 * height), controlPoint1: CGPoint(x: 0.9585 * width, y: 0.47504 * height), controlPoint2: CGPoint(x: 0.95098 * width, y: 0.46658 * height))
    ...
    path.addCurve(to: CGPoint(x: 0.54616 * width, y: 0.14579 * height), controlPoint1: CGPoint(x: 0.55062 * width, y: 0.14271 * height), controlPoint2: CGPoint(x: 0.54814 * width, y: 0.14524 * height))
    ...
    addToScene(scene, path, 80, "GRAY", SCNVector3(x: 0, y: 0, z: 0), UIColor.gray)
    
    var color = UIColor(red: 214 / 255, green: 41 / 255, blue: 45 / 255, alpha: 1)
    path = UIBezierPath()
    ...
    addToScene(scene, path, depth, "SOY", secondLevel, color)
    ...
    path.addCurve(to: CGPoint(x: 0.46372*width, y: 0.65296*height), controlPoint1: CGPoint(x: 0.47367*width, y: 0.64993*height), controlPoint2: CGPoint(x: 0.46867*width, y: 0.65272*height))
    path.addCurve(to: CGPoint(x: 0.45125*width, y: 0.64729*height), controlPoint1: CGPoint(x: 0.45998*width, y: 0.65332*height), controlPoint2: CGPoint(x: 0.45367*width, y: 0.65083*height))
    path.addCurve(to: CGPoint(x: 0.44752*width, y: 0.63549*height), controlPoint1: CGPoint(x: 0.44901*width, y: 0.64454*height), controlPoint2: CGPoint(x: 0.4466*width, y: 0.63893*height))
    path.addCurve(to: CGPoint(x: 0.45259*width, y: 0.62512*height), controlPoint1: CGPoint(x: 0.4476*width, y: 0.63242*height), controlPoint2: CGPoint(x: 0.44983*width, y: 0.62718*height))
    path.addCurve(to: CGPoint(x: 0.46614*width, y: 0.6211*height), controlPoint1: CGPoint(x: 0.45556*width, y: 0.62285*height), controlPoint2: CGPoint(x: 0.4619*width, y: 0.6203*height))
    ...
    addToScene(scene, path, depth, "PEQUEÑOS 1", secondLevel, color)
    ...
    addToScene(scene, path, depth, "EXPRESO", secondLevel, color)
    ...
    addToScene(scene, path, depth, "COMPRENDO", secondLevel, color)
    ...
    textNode.position = SCNVector3(100, 250, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "IMAX"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "COMPRENDO", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(390, 325, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    ...
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(670, 500, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "EXPRESO"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "PEQUEÑOS", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(740, 760, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, -0.5)
    textNode.name = "PEQUEÑOS 1"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "SOY", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(650, 820, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "SOY"
    scene.rootNode.addChildNode(textNode)
...
func setupFloor1(_ scene: SCNScene, _ width: Double, _ height: Double){
    let secondLevel = SCNVector3(0, 0, -60)
    let thirdLevel = SCNVector3(0, 0, -100)
    let depth : CGFloat = 40
    ...
    addToScene(scene, path, depth, "PERTENEZCO", secondLevel, color)
    ...
    addToScene(scene, path, depth, "PEQUEÑOS 2", secondLevel, color)
    ...
    addToScene(scene, path, depth, "TIENDA", secondLevel, color)
    ...
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    var textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(150, 490, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "TIENDA"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "EXPOSICIONES TEMPORALES", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(370, 280, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "EXPOSICIONES TEMPORALES"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "PERTENEZCO", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(750, 525, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    ...
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(665, 835, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0)
    textNode.name = "PEQUEÑOS 2"
    scene.rootNode.addChildNode(textNode)
    
    textGeometry = SCNText(string: "COMUNICO", extrusionDepth: 1)
    textGeometry.font = UIFont.boldSystemFont(ofSize: 16)
    textGeometry.firstMaterial?.diffuse.contents = UIColor.black
    textNode = SCNNode(geometry: textGeometry)
    textNode.position = SCNVector3(490, 710, -80)
    textNode.eulerAngles = SCNVector3(3.1416, 0, 0.9)
